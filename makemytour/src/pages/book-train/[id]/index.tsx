...
const BookTrainPage = () => {
  ...
  const handleQuantityChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setQuantity(
      isNaN(value) ? 1 : Math.max(1, Math.min(value, train.availableSeats))
    );
  };
      ...
      <div className="grid gap-6 mt-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            <Label htmlFor="trainName" className="flex items-center">
              <TrainFront className="w-4 h-4 mr-2" />
              Train Name
            </Label>
            <Input id="trainName" value={train?.trainName} readOnly />
          </div>
          <div className="space-y-2">
            ...
            <Input id="from" value={train?.from} readOnly />
          </div>
          <div className="space-y-2">
            ...
            <Input id="to" value={train?.to} readOnly />
          </div>
          <div className="space-y-2">
            ...
            <Input
              id="departureTime"
              value={new Date(train.departureTime).toLocaleString()}
              readOnly
            />
          </div>
          <div className="space-y-2">
            ...
            <Input
              id="arrivalTime"
              value={new Date(train.arrivalTime).toLocaleString()}
              readOnly
            />
          </div>
          <div className="space-y-2">
